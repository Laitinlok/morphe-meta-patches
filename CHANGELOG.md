...
* **ci:** restore semantic-release rules so feat, fix, and release commits trigger versions ([3728b97](https://github.com/Laitinlok/morphe-meta-patches/commit/3728b978519854968a56847075aa9d58565a85e3))
* explicitly reject non-split (Universal) APKs due to Redex obfuscation ([409371a](https://github.com/Laitinlok/morphe-meta-patches/commit/409371ae4e6f2764dca505ee540c6df5033fee26))
* google photos patch logic ([58f8bc8](https://github.com/Laitinlok/morphe-meta-patches/commit/58f8bc80dfd601cfe5a5dfee81e64d78bab0f496))
* make Google Photos spoof build patch self-contained ([7b431dd](https://github.com/Laitinlok/morphe-meta-patches/commit/7b431dd5a707231b5289db60a6fdee5d24b27832))
* make gradlew executable ([3be2ec5](https://github.com/Laitinlok/morphe-meta-patches/commit/3be2ec51fff5990c174c166e7a02625971832063))
* Relax sponsored data fingerprint to match non-split APKs ([b585486](https://github.com/Laitinlok/morphe-meta-patches/commit/b585486635154de3267c3ca9cfdb83ef32b00ce7))
* release 1.0.1 ([b68b315](https://github.com/Laitinlok/morphe-meta-patches/commit/b68b31503e57a9253237a3bf2be8bacfd23f7c86))
* release 1.0.1 ([26175cf](https://github.com/Laitinlok/morphe-meta-patches/commit/26175cf2910917be08734a741087018e127a1648))
* release v1.0.3 with Google Recorder fix ([c03c701](https://github.com/Laitinlok/morphe-meta-patches/commit/c03c701a6ba658afb4f4f2093faca9e6bc91e49c))
* Remove class constraint, use structural matching for sponsored data fingerprint ([f8c18f8](https://github.com/Laitinlok/morphe-meta-patches/commit/f8c18f877ca264c6d50978565d54cffc26810a59))
* Remove dead resource mapping imports and fix GPR auth token ([d10cbc6](https://github.com/Laitinlok/morphe-meta-patches/commit/d10cbc647a4c0f3fb847ea03d72cccc9077ed546))
* Use CONTAINS match for GraphQLFBMultiAdsFeedUnit class lookup ([bc766b3](https://github.com/Laitinlok/morphe-meta-patches/commit/bc766b337843fc1e8eb4814e2c20042fd38e508e))
* Use expression-style in custom lambda (return prohibited in non-inline lambda) ([f6829b3](https://github.com/Laitinlok/morphe-meta-patches/commit/f6829b32bfff035eaa01e18b85d57d57a7383a71))


### Features

* bump supported Facebook split version to v556 and dynamically construct mirror query ([39a97f3](https://github.com/Laitinlok/morphe-meta-patches/commit/39a97f3cf450b90592c82ee5b46fd75baf140a5e))
* release v1.1.0 ([901b2ec](https://github.com/Laitinlok/morphe-meta-patches/commit/901b2ec28fb8e5863d2085d471f0cf529de08422))
